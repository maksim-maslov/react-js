...
const Basket = ({ basketVisibility, productsInBasket, updateBasket }) => {
  return(        
            ...
            {productsInBasket.map((el, index) => {
              return(
                <div key={index} className="product-list__item">
                  ...
                  <div className="product-list__price">{el.item.price} <i className="fa fa-rub" aria-hidden="true"></i></div>
